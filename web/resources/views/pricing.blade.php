...
<body>
    ...
    <main class="wrap hero">
        <section>
            <span class="pill">7-day free trial</span>
            <h1>Pricing</h1>
        ...
        <section class="visual" aria-label="HeyBean app preview">
            ...
            <div class="mini-card">Premium is built for everyday household use<small>Coordinate shared plans, recurring routines, reminders, calendars, and a full year of context.</small></div>
        </section>
    </main>
