        ...
        <div class="plans">
            <article class="plan">
                ...
                <ul class="features">
                    ...
                    <li>Recent history so Bean can follow the thread</li>
                    <li>Unlimited Bean use included during beta</li>
                </ul>
