...
@section('content')
    ...
    <p>HeyBean is a productivity app for calendar planning, tasks, reminders, notes, household coordination, and related workflows. This policy explains what information we collect, how we use it, and the choices you have.</p>

    <h2>Information we collect</h2>
    <ul>
        <li><strong>Account information:</strong> name, email address, password hash, authentication tokens, and account settings.</li>
        <li><strong>Productivity content:</strong> preferences, tasks, reminders, calendar events, notes, workspace/household information, and activity records you create.</li>
    ...
    <ul>
        <li>Provide the HeyBean app, including calendar planning, reminders, tasks, notes, and workspace syncing.</li>
    ...
    <p>HeyBean processes the account and productivity data you enter to display, synchronize, and protect your calendars, tasks, reminders, notes, and workspaces. We do not use your personal content for third-party advertising.</p>

    <h2>Sharing</h2>
    <p>We share data with service providers that help operate HeyBean, such as hosting, email, calendar APIs, analytics/diagnostics, payment processing, and security tools. We may disclose information if required by law or to protect users, the service, or others.</p>
