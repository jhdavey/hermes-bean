...
<head>
    ...
    <style>
        :root{--ink:#102016;--muted:#627066;--green:#16a34a;--green-dark:#087a35;--cream:#fbf7ed;--line:#dce8dd;--gold:#f59e0b}*{box-sizing:border-box}body{margin:0;font-family:ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:var(--ink);background:radial-gradient(circle at top left,rgba(22,163,74,.18),transparent 30%),linear-gradient(180deg,#fffaf0,#edf8ee 55%,#fffaf5);overflow-x:hidden}a{color:inherit}.wrap{width:min(1160px,calc(100% - 32px));margin:0 auto}.nav{display:flex;align-items:center;justify-content:space-between;padding:22px 0;gap:18px;position:relative}.brand{display:flex;align-items:center;gap:10px;text-decoration:none;font-weight:900}.brand img{width:38px;height:38px;border-radius:12px}.navlinks{display:flex;gap:18px;align-items:center;flex-wrap:wrap;color:var(--muted);font-size:14px}.navlinks a{text-decoration:none}.mobile-menu{display:none}.mobile-menu summary{list-style:none;cursor:pointer;border:1px solid var(--line);background:rgba(255,255,255,.86);border-radius:999px;padding:10px 14px;font-size:14px;font-weight:900;color:#102016;box-shadow:0 12px 30px rgba(24,80,40,.1)}.mobile-menu summary::-webkit-details-marker{display:none}.mobile-menu-panel{position:absolute;right:0;top:70px;z-index:20;display:grid;gap:6px;min-width:210px;padding:10px;background:rgba(255,255,255,.96);border:1px solid var(--line);border-radius:22px;box-shadow:0 24px 60px rgba(24,80,40,.18);backdrop-filter:blur(14px)}.mobile-menu-panel a{text-decoration:none;color:#102016;font-weight:850;padding:12px 14px;border-radius:14px}.mobile-menu-panel a:hover{background:#effaf0}.pill{display:inline-flex;align-items:center;gap:8px;border:1px solid #bfe6c8;background:#effaf0;border-radius:999px;padding:8px 12px;color:#087a35;font-weight:900;font-size:13px}.hero{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(320px,.95fr);gap:46px;align-items:center;padding:34px 0 72px}.hero h1{font-size:clamp(48px,8vw,92px);line-height:.88;letter-spacing:-.075em;margin:18px 0;color:#0c1c12}.hero p{font-size:clamp(18px,2.4vw,23px);line-height:1.45;color:var(--muted);max-width:660px}.cta{display:flex;gap:12px;flex-wrap:wrap;margin:26px 0}.form{display:flex;gap:10px;background:white;border:1px solid var(--line);padding:12px;border-radius:24px;box-shadow:0 18px 50px rgba(24,80,40,.12);max-width:560px;margin-bottom:6px;min-height:72px;align-items:center}.form input{flex:1;border:0;outline:0;font-size:16px;padding:14px 14px;min-width:180px;min-height:48px}.button,button{border:0;border-radius:16px;background:var(--green);color:white;padding:14px 18px;font-weight:900;font-size:15px;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center;justify-content:center}.button.secondary{background:white;color:#102016;border:1px solid var(--line)}.micro{font-size:13px!important;color:#758177!important}.proof{display:flex;gap:10px;flex-wrap:wrap;margin-top:18px}.proof span{background:rgba(255,255,255,.72);border:1px solid var(--line);border-radius:999px;padding:9px 12px;font-size:13px;font-weight:800}.phone-wrap{position:relative;display:grid;place-items:center}.halo{position:absolute;width:520px;height:520px;border-radius:50%;background:radial-gradient(circle,rgba(22,163,74,.26),transparent 68%);filter:blur(8px)}.phone{position:relative;background:#101412;border-radius:54px;padding:14px;box-shadow:0 36px 90px rgba(9,40,20,.35),inset 0 0 0 1px rgba(255,255,255,.18);transform:rotate(2deg)}.phone:before{content:"";position:absolute;top:22px;left:50%;transform:translateX(-50%);width:118px;height:31px;border-radius:18px;background:#070a08;z-index:3}.phone img{display:block;width:min(430px,76vw);height:auto;border-radius:42px}.callout{position:absolute;background:white;border:1px solid var(--line);border-radius:18px;padding:12px 14px;box-shadow:0 18px 45px rgba(20,70,35,.18);font-weight:900}.callout small{display:block;color:var(--muted);font-weight:700}.c1{right:-12px;top:120px}.c2{left:-10px;bottom:145px}.section{padding:72px 0;border-top:1px solid rgba(16,32,22,.08)}.section h2{font-size:clamp(34px,5vw,58px);line-height:.96;letter-spacing:-.055em;margin:0 0 16px}.lead{font-size:20px;color:var(--muted);max-width:720px}.logistics-layout{display:grid;grid-template-columns:minmax(0,1.04fr) minmax(320px,.96fr);gap:28px;align-items:start;margin-top:30px}.chat-mockup{position:relative;display:grid;place-items:center;min-height:100%;padding:6px 12px 12px;background:radial-gradient(circle at 50% 44%,rgba(22,163,74,.18),transparent 62%)}.chat-phone{position:relative;width:min(345px,100%);background:#101412;border-radius:54px;padding:13px;box-shadow:0 34px 90px rgba(9,40,20,.32),inset 0 0 0 1px rgba(255,255,255,.18)}.chat-phone:before{content:"";position:absolute;top:21px;left:50%;transform:translateX(-50%);width:104px;height:29px;border-radius:18px;background:#070a08;z-index:4}.chat-art{position:relative;overflow:hidden;border-radius:42px;line-height:0;background:#f7f4ea}.chat-base{display:block;width:100%;height:auto;aspect-ratio:430/932;object-fit:contain}.chat-screen{position:absolute;inset:0;overflow:hidden;color:#102016;display:flex;flex-direction:column;line-height:normal}.chat-ios{display:flex;justify-content:space-between;align-items:center;padding:15px 22px 9px;font-size:12px;font-weight:900;color:#15251a}.chat-appbar{display:flex;align-items:center;gap:10px;margin:0 12px 10px;padding:14px 12px 10px;border:1px solid rgba(16,32,22,.08);border-radius:22px;background:rgba(255,255,255,.76);backdrop-filter:blur(10px)}.chat-avatar{width:38px;height:38px;border-radius:14px;background:white;padding:4px;box-shadow:0 8px 20px rgba(24,80,40,.12)}.chat-title{font-weight:950}.chat-subtitle{font-size:12px;color:#627066;font-weight:800}.chat-tools{margin-left:auto;display:flex;gap:8px}.chat-tools span{display:grid;place-items:center;min-width:34px;height:34px;border-radius:14px;background:white;border:1px solid var(--line);font-weight:950}.chat-body{display:grid;gap:10px;align-content:start;flex:1;padding:6px 14px 12px;overflow:hidden}.bubble{border-radius:22px;padding:11px 13px;line-height:1.34;box-shadow:0 12px 26px rgba(24,80,40,.1);font-size:12.5px}.bubble.user{background:#16a34a;color:white;margin-left:34px;border-bottom-right-radius:8px}.bubble.bean{background:white;border:1px solid #dce8dd;color:#102016;margin-right:26px;border-bottom-left-radius:8px}.bubble.progress{background:#edf8ee;color:#087a35;border:1px solid #bfe6c8;font-weight:850}.bubble b{display:block;margin-bottom:5px}.plan-list{display:grid;gap:7px;margin:9px 0 0;padding:0;list-style:none}.plan-list li{display:flex;gap:8px;align-items:flex-start;background:#f4fbf4;border:1px solid #dce8dd;border-radius:14px;padding:8px 9px}.plan-list li>span:first-child{color:#16a34a;font-weight:950}.chat-actions{display:flex;gap:7px;flex-wrap:wrap;margin-top:10px}.chat-actions span{border:1px solid #bfe6c8;background:#effaf0;border-radius:999px;padding:7px 9px;color:#087a35;font-size:11px;font-weight:900}.chat-composer{display:flex;align-items:center;gap:8px;margin:0 12px 10px;padding:9px 10px;background:rgba(255,255,255,.9);border:1px solid #dce8dd;border-radius:22px;box-shadow:0 12px 30px rgba(24,80,40,.1);font-size:12px;color:#627066;backdrop-filter:blur(10px)}.chat-send{margin-left:auto;background:#16a34a;color:white;border-radius:50%;width:28px;height:28px;display:grid;place-items:center;font-weight:950}.chat-tabbar{display:grid;grid-template-columns:repeat(5,1fr);gap:2px;padding:8px 8px 12px;background:#0d2415;color:#dff8e5;font-size:10px;text-align:center}.chat-tabbar span{padding:7px 2px;border-radius:14px}.chat-tabbar .bean-tab{background:#16a34a;color:white;font-weight:950}.logistics-layout .flow{grid-template-columns:1fr;margin-top:0}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:28px}.card{background:rgba(255,255,255,.78);border:1px solid var(--line);border-radius:28px;padding:24px;box-shadow:0 16px 50px rgba(24,80,40,.08)}.card b{display:block;font-size:19px;margin-bottom:8px}.card p{color:var(--muted);line-height:1.55}.flow{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-top:26px}.step{background:#102016;color:white;border-radius:26px;padding:24px}.step span{display:grid;place-items:center;width:34px;height:34px;border-radius:50%;background:#16a34a;font-weight:900;margin-bottom:22px}.step p{color:#dbe8dd}.quote{background:#102016;color:white;border-radius:36px;padding:38px;margin-top:28px;display:grid;grid-template-columns:1fr auto;gap:20px;align-items:center}.quote p{font-size:24px;line-height:1.35;margin:0;color:#effaf0}.footer{padding:40px 0;color:#68766d;display:flex;gap:18px;justify-content:space-between;flex-wrap:wrap;font-size:14px}.footer a{color:#087a35;font-weight:800;text-decoration:none}@media(max-width:860px){.hero,.grid,.flow,.quote,.logistics-layout{grid-template-columns:1fr}.nav{padding:16px 0}.navlinks{display:none}.mobile-menu{display:block}.form{flex-direction:column;align-items:stretch;padding:14px;min-height:132px}.form input{min-height:56px}.form button{min-height:52px}.phone{transform:none}.callout{display:none}}
    ...
    <section class="wrap section" id="how">
        ...
        <div class="logistics-layout">
            <div class="chat-mockup" aria-label="Bean planning chat mockup">
                <div class="chat-phone" aria-label="iPhone-style Bean chat screen mockup using provided phone image">
                    <div class="chat-art">
                        <img class="chat-base" src="{{ asset('images/bean-chat-screen-base.jpg') }}" width="430" height="932" alt="Provided non-distorted phone mockup background">
                        <div class="chat-screen">
                            <div class="chat-ios"><span>9:41</span><span>●●● 5G ▰</span></div>
                            <div class="chat-appbar"><img class="chat-avatar" src="{{ asset('images/bean-logo.png') }}" alt=""><div><div class="chat-title">Bean</div><div class="chat-subtitle">Ready · planning workspace</div></div><div class="chat-tools"><span>/new</span><span>☰</span></div></div>
                            <div class="chat-body">
                            ...
                            <div class="chat-composer"><span>Message Bean…</span><span class="chat-send">↑</span></div>
                            <div class="chat-tabbar"><span>Today</span><span>Tasks</span><span class="bean-tab">Bean</span><span>Reminders</span><span>Settings</span></div>
                        </div>
                    </div>
                </div>
            </div>
