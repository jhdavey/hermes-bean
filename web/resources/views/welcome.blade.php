...
<body>
    ...
    <main class="wrap hero">
        <section>
            ...
            <p class="micro"><strong>Use your voice:</strong> say “Hey Bean, add…” to create events, reminders, and tasks without typing.</p>
