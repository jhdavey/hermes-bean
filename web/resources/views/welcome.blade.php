...
<head>
    ...
    <style>
        ...
        .bean-proof-hotspot{position:absolute;z-index:6;display:grid;place-items:center;border-radius:999px;background:rgba(22,163,74,.16);box-shadow:0 10px 28px rgba(22,163,74,.22);opacity:0;transform:scale(.9)}
        .bean-proof-hotspot:before{content:"";width:56%;height:56%;border-radius:999px;background:rgba(22,163,74,.72);box-shadow:0 0 0 9px rgba(22,163,74,.16)}
        .bean-proof-hotspot.event{left:28%;right:6.4%;top:85.9%;height:6.7%;border-radius:30px;background:rgba(22,163,74,.10)}
        .bean-proof-hotspot.event:before{justify-self:end;margin-right:7%;width:13%;height:58%;border-radius:999px}
        .bean-proof-hotspot.reminder-card{left:7.5%;right:7.5%;top:22.9%;height:8.7%;border-radius:28px;background:rgba(251,191,36,.13)}
        .bean-proof-hotspot.reminder-card:before{justify-self:end;margin-right:6%;width:12%;height:56%;border-radius:999px;background:rgba(22,163,74,.66)}
                            ...
                            <div class="bean-demo-overlay">
                                ...
                                <div class="bean-demo-proof-shell" aria-hidden="true">
                                    <div class="bean-proof-screen calendar">
                                        ...
                                        <span class="bean-proof-hotspot event" aria-hidden="true"></span>
                                    </div>
                                    <div class="bean-proof-screen reminders">
                                        ...
                                        <span class="bean-proof-hotspot reminder-card" aria-hidden="true"></span>
                                    </div>
