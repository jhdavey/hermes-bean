    ...
    <section class="wrap section" id="how">
        ...
        <div class="logistics-layout">
            <div class="chat-mockup" aria-label="Bean planning chat mockup">
                <div class="chat-top"><div class="chat-brand"><img src="{{ asset('images/bean-logo.png') }}" alt=""><span>Bean chat</span></div><span class="chat-status">Planning week…</span></div>
                <div class="chat-body">
