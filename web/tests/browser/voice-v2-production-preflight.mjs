...
try {
    ...
    record('wake_manifest_v10', wakeManifestResponse.status === 200
    ...
    if (typeof wakeManifest?.worker === 'string') {
        ...
        record('wake_worker_v10', worker.status === 200
        ...
        record('wake_worker_v10', false, null, 'current first-party wake worker');
    }
