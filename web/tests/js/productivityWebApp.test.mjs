...
test('web signup uses the Zero Chrome Bean onboarding contract', () => {
    ...
    assert.match(source, /completed_step: 'name'/);
    assert.match(source, /next_step: 'themeMode'/);
    assert.match(source, /completed_step: 'themeMode'/);
    assert.match(source, /next_step: 'email'/);
    assert.match(source, /completed_step: 'email'/);
