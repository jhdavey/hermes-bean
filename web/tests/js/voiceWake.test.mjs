...
assert.equal(voiceCommandNeedsAgentWork('when does my local Ace Hardware close today'), true);
assert.equal(voiceCommandNeedsAgentWork('is the pharmacy near me open tonight'), true);
