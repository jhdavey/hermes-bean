...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('Bean is not nine separate tools.', false)
            ->assertSee('class="capability-map"', false)
            ->assertSee('Core assistant', false)
            ->assertSee('Plan your day', false)
            ->assertSee('Capture what matters', false)
            ->assertSee('Keep context together', false)
            ->assertSee('Calendar updated', false)
            ->assertSee('Task synced', false)
            ->assertSee('Reminder sent', false)
            ->assertSee('Approval required', false)
            ->assertSee('Open space found', false)
            ->assertSee('Critical task saved', false)
            ->assertSee('Review before sending', false)
