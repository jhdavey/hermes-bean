...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('.phone img{display:block;height:min(700px,112vw);width:auto;max-width:min(360px,70vw);aspect-ratio:auto;object-fit:contain', false)
            ->assertSee('.phone img{height:min(620px,150vw);width:auto;max-width:82vw}', false)
