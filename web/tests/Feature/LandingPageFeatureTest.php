...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('Accounts connected', false)
            ->assertSee('Critical items flagged', false)
            ->assertSee('Routines tracked', false)
            ->assertSee('Approvals queued', false)
            ->assertSee('Open space', false)
            ->assertSee('Critical task', false)
            ->assertSee('Review queue', false)
