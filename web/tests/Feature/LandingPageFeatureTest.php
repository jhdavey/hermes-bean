...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('Simple schedule and task management, with Bean built in.', false)
            ->assertSee('Use the app directly for reliable calendars, tasks, and reminders.', false)
            ->assertSee('class="capability-map"', false)
            ->assertSee('class="capability-lanes feature-grid"', false)
            ->assertSee('class="feature-shot"', false)
            ->assertSee('Calendar', false)
            ->assertSee('School drop-off', false)
            ->assertSee('Team check-in', false)
            ->assertSee('Daily, weekly, and monthly views', false)
            ->assertSee('Tasks', false)
            ->assertSee('Send field trip form', false)
            ->assertSee('Pack soccer bag', false)
            ->assertSee('Priority and categories', false)
            ->assertSee('Reminders', false)
            ->assertSee('Trash and recycling', false)
            ->assertSee('Take medication', false)
            ->assertSee('Push and email alerts', false)
            ->assertSee('Bean AI assistant', false)
            ->assertSee('What is left before dinner?', false)
            ->assertSee('Suggested next action', false)
            ->assertSee('Create and update', false)
            ->assertSee('Answer schedule questions', false)
            ...
            ->assertSee('Open the app to manage your day. Ask Bean when you want it done faster.', false)
