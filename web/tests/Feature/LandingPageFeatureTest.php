...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ->assertSee('Say: <span style="white-space: nowrap;">“Hey Bean…”</span> then say what you need.', false)
            ->assertSee('AI executive assistant for busy people and households', false)
            ->assertSee('Start requests with “Hey Bean…”', false)
            ->assertSee('keep home and work moving from one focused conversation', false)
