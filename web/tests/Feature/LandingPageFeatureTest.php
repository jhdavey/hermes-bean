...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_public_pages_present_the_bean_assistant_and_beta_signup(): void
    {
        ...
        $this->get('/')
            ...
            ->assertDontSee('class="hero-icon bean"', false)
            ->assertDontSee('.hero-icon.bean,.hero-icon.bean img{width:45px;height:45px}', false)
            ->assertSee('Hi! I\'m Bean. Your new assistant!', false)
            ->assertSee('Bean is here to help you stay organized and on top of things like your calendar, tasks, reminders and more.', false)
            ->assertSee('Across personal and shared workspaces, Bean is by your side, 24/7.', false)
            ->assertDontSee('Stop carrying every detail yourself.', false)
            ->assertDontSee('See Bean in action', false)
            ...
            ->assertSee('class="public-landing-signup-flow"', false)
            ->assertSee('data-from-landing-bean="true"', false)
            ->assertSee('/build/assets/landingSignup-', false)
            ...
            ->assertDontSee('href="/register?from=topbar_button"', false)
