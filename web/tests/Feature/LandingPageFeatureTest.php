...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('See Bean turn one request into a finished plan', false)
            ...
            ->assertSee('One natural “Hey Bean…” request becomes visible app changes', false)
            ->assertSee('Hey Bean, move my focus block to 3', false)
            ->assertSee('Large product screenshot placeholder for the How it works demo', false)
            ->assertSee('How Bean works storyboard', false)
            ->assertSee('Screenshot placeholder', false)
            ->assertSee('Calendar updated', false)
            ->assertSee('Reminder created', false)
            ->assertSee('Household task synced', false)
            ->assertSee('Focus block · 3:00 PM', false)
            ->assertSee('Waiting for approval', false)
            ->assertSee('images/how-it-works-ask.png', false)
            ->assertSee('images/how-it-works-organize.png', false)
            ->assertSee('images/how-it-works-control.png', false)
            ...
            ->assertDontSee('images/bean-logistics-conversation.png', false)
            ->assertDontSee('width="500" height="1080"', false)
            ...
            ->assertSee('class="how-story"', false)
            ...
            ->assertSee('.how-story{display:grid;grid-template-columns:minmax(0,1.02fr) minmax(340px,.98fr)', false)
            ->assertSee('.story-phone-frame{position:relative;z-index:2;width:min(342px,100%)', false)
            ->assertSee('.story-screenshot-placeholder{min-height:600px;aspect-ratio:1170/2532', false)
