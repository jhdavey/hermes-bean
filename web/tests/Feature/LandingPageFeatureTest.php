...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $this->get('/')
            ...
            ->assertSee('Run your day from one calm assistant dashboard', false)
            ...
            ->assertSee('Calendar, tasks, and reminders stay together.', false)
    ...
    public function test_pricing_page_shows_plans_and_trial_ctas(): void
    {
        $this->get('/pricing')
            ->assertOk()
            ->assertSee('More Bean, with less effort.', false)
            ->assertSee('Choose the amount of Bean your day needs.', false)
