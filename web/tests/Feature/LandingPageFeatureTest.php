...
class LandingPageFeatureTest extends TestCase
{
    ...
    public function test_homepage_is_the_heybean_beta_landing_page(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('iPhone-style Bean chat screen mockup using provided phone image', false)
            ->assertSee('images/bean-chat-screen-base.jpg', false)
            ->assertSee('width="430" height="932"', false)
            ->assertSee('aspect-ratio:430/932', false)
            ->assertSee('object-fit:contain', false)
            ->assertSee('Ready · planning workspace', false)
            ->assertSee('Working… checking calendar, tasks, reminders, and household context.', false)
            ->assertSee('Message Bean…', false)
            ->assertSee('class="bean-tab"', false)
