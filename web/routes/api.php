...
Route::middleware('api.rate_limit')->group(function (): void {
    ...
    Route::middleware('auth.bearer')->group(function (): void {
        ...
        Route::middleware('early_access.admitted')->group(function (): void {
        ...
        Route::middleware('product.access')->group(function (): void {
            ...
            Route::get('/bean/sessions', [BeanController::class, 'sessions']);
            Route::post('/bean/sessions', [BeanController::class, 'storeSession']);
            Route::get('/bean/sessions/{session}/activity', [BeanController::class, 'activity']);
