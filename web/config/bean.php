...
return [
    ...
    */
    ...
    'landing' => [
        ...
        'timeout_seconds' => (int) env('BEAN_LANDING_HERMES_TIMEOUT_SECONDS', 12),
        ...
        'sessions_per_minute' => max(4, (int) env('BEAN_LANDING_SESSIONS_PER_MINUTE', 4)),
        'sessions_per_hour' => max(12, (int) env('BEAN_LANDING_SESSIONS_PER_HOUR', 12)),
        'sessions_per_day' => max(40, (int) env('BEAN_LANDING_SESSIONS_PER_DAY', 40)),
