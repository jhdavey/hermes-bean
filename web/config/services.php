...
return [
    ...
    */
    ...
    'hermes_runtime' => [
        ...
        'geoapify_places_enabled' => (bool) env('GEOAPIFY_PLACES_ENABLED', true),
        'geoapify_api_key' => env('GEOAPIFY_API_KEY', ''),
        'geoapify_places_radius_meters' => (int) env('GEOAPIFY_PLACES_RADIUS_METERS', 25000),
        'geoapify_places_timeout' => (float) env('GEOAPIFY_PLACES_TIMEOUT', 6),
        'geoapify_places_connect_timeout' => (float) env('GEOAPIFY_PLACES_CONNECT_TIMEOUT', 2),
