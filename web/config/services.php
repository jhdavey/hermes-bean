...
return [
    ...
    */
    ...
    'hermes_runtime' => [
        ...
        'fast_chat_timeout' => (float) env('HERMES_FAST_CHAT_TIMEOUT', 6),
        'fast_chat_recovery_timeout' => (float) env('HERMES_FAST_CHAT_RECOVERY_TIMEOUT', 8),
        'browser_voice_complex_timeout' => (float) env('HERMES_BROWSER_VOICE_COMPLEX_TIMEOUT', 7),
        'browser_voice_complex_recovery_timeout' => (float) env('HERMES_BROWSER_VOICE_COMPLEX_RECOVERY_TIMEOUT', 8),
