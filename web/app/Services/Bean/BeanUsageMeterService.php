        ...
        return BeanUsageRecord::updateOrCreate(
            ...
            [
                ...
                'metadata' => [
                    ...
                    'initial_wait_seconds_configured' => (int) config('bean.usage.elevenlabs_initial_wait_seconds', 5),
                    'silence_end_call_seconds_configured' => (int) config('bean.usage.elevenlabs_silence_end_call_seconds', 12),
                    'followup_idle_close_seconds_configured' => (int) config('bean.usage.elevenlabs_followup_idle_close_seconds', 12),
        ...
        return BeanUsageRecord::updateOrCreate(
            ...
            [
                ...
                'metadata' => [
                    ...
                    'wake_to_first_speech_ms' => isset($payload['wake_to_first_speech_ms']) ? (int) $payload['wake_to_first_speech_ms'] : null,
                    'wake_to_first_speech_target_ms' => isset($payload['wake_to_first_speech_target_ms']) ? (int) $payload['wake_to_first_speech_target_ms'] : null,
                    'wake_to_first_speech_target_met' => isset($payload['wake_to_first_speech_target_met']) ? (bool) $payload['wake_to_first_speech_target_met'] : null,
                    'hermes_runtime_samples_ms' => collect($payload['hermes_runtime_samples_ms'] ?? [])->filter(fn ($value): bool => is_numeric($value))->map(fn ($value): int => (int) $value)->values()->all(),
                    'max_duration_seconds_configured' => (int) config('bean.usage.elevenlabs_max_duration_seconds', 60),
                    'silence_timeout_seconds_configured' => (int) config('bean.usage.elevenlabs_silence_timeout_seconds', 5),
                    'cost_per_minute_usd' => $costPerMinute,
                    'credits_per_minute' => $creditsPerMinute,
