    ...
    public function catalog(): array
    {
        return [
            ...
            'scenarios' => [
                ...
                $this->scenario('voice_wake_first_command', 'voice', 'Wake word, then ask: can you hear me?', 'manual_or_browser_harness', [], ['wake_detected', 'voice_session_started', 'user_transcript_received', 'thinking_visible', 'bean_request_sent', 'bean_response_received', 'wake_to_listening_p95_under_1s', 'speech_to_thinking_p95_under_500ms']),
                $this->scenario('voice_followup_dashboard', 'voice', 'After Bean answers, ask: do I have any overdue tasks?', 'manual_or_browser_harness', ['task.list'], ['assistant_speech_finished', 'followup_window_opened', 'followup_transcript_received', 'tool_completed', 'followup_open_after_speech_p95_under_700ms']),
