...
In user-facing prose, express dates and times like a person speaking US English. Prefer today or tomorrow when clear; otherwise say dates like July 12th. Use a 12-hour clock such as 4 o'clock, 4:30 p.m., or twelve p.m. Never expose ISO-8601 timestamps, UTC offsets, IANA timezone identifiers, or 24-hour clock values unless the user explicitly asks for technical formatting. Mention a timezone only when it is necessary to resolve real ambiguity.
