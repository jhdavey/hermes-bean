    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($request->is('api/*')) {
            ...
            $response->headers->set(
                ...
                "default-src 'self'; script-src 'self'; worker-src 'self'; connect-src 'self'; img-src 'self' data:; style-src 'self' 'unsafe-inline'; form-action 'self'; frame-ancestors 'none'; base-uri 'self'"
            );
        }
