...
const List<_SignupPlanOption> _signupPlanOptions = [
  ...
  _SignupPlanOption(
    ...
    priceSuffix: '/mo',
    description: 'For families and power users with busy daily routines.',
    trialText: '$_subscriptionTrialLabel, then billed monthly',
    ...
    features: [
      ...
      'More workspaces for everyday planning',
  ...
  _SignupPlanOption(
    ...
    priceSuffix: '/mo',
    description:
        'For people organizing every workspace, account, and recurring workflow.',
    trialText: '$_subscriptionTrialLabel, then billed monthly',
    actionLabel: 'Start Pro trial',
    finePrint: 'Built for users coordinating every area of their day.',
    features: [
      'Unlimited workspaces for every area of life',
      'Unlimited tasks and reminders for high-volume days',
      'More room for connected calendars',
