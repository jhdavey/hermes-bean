...
const List<_OnboardingTourStepConfig> _appOnboardingTourSteps = [
  _OnboardingTourStepConfig(
    ...
    caption:
        "This is your command center, with today's events, tasks, and reminders in one running list.",
    destination: _HomeDestination.commandCenter,
  ...
  _OnboardingTourStepConfig(
    title: 'Tasks',
    caption:
        'Tasks are for things you need to complete. Add the details you need, then check each task off when done.',
  ...
  _OnboardingTourStepConfig(
    title: 'Notes',
    caption:
        'Notes hold plans, lists, and longer writing. Folders and formatting keep everything organized.',
