...
class _NotesView extends StatefulWidget {
  ...
  final List<BeanNoteFolder> folders;
  final List<BeanNote> notes;
  final List<BeanWorkspace> workspaces;
  final String? activeWorkspaceId;
  final int? openNoteId;
  final Future<BeanNoteFolder> Function(String name) onFolderCreated;
  final Future<void> Function(BeanNoteFolder folder) onFolderDeleted;
...
class _NotesViewState extends State<_NotesView> {
  ...
  List<BeanNote> get _filteredNotes {
  ...
  BeanNote? get _selectedNote => widget.notes
  ...
  BeanNoteFolder? _folderFor(int? id) =>
  ...
  List<BeanNote> _sortNotesForList(List<BeanNote> notes) {
    final sorted = [...notes];
    switch (_noteSort) {
      case 'title':
        sorted.sort(
  ...
  Future<bool> _deleteFolder(BeanNoteFolder folder) async {
  ...
  bool _noteIsLocked(BeanNote? note) {
  ...
  Widget _buildListScreen(List<BeanNote> notes) {
  ...
  Widget _buildDetailScreen(BeanNote selected) {
...
class _NotesListOptionsSheet extends StatefulWidget {
  ...
  final Future<bool> Function(BeanNoteFolder folder) onDeleteFolder;
...
class _NotesListOptionsSheetState extends State<_NotesListOptionsSheet> {
  ...
  Future<void> _deleteFolder(BeanNoteFolder folder) async {
...
class _NoteSection extends StatelessWidget {
  ...
  final String? title;
  final List<BeanNote> notes;
  final ValueChanged<BeanNote> onTap;
