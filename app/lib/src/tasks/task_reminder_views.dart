...
class _TaskListCardState extends State<_TaskListCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final todayTasks = <BeanTask>[];
    final upcomingTasks = <BeanTask>[];
    final moreThanSevenDaysTasks = <BeanTask>[];
    final moreThanThirtyDaysTasks = <BeanTask>[];
    ...
    final activeSubtasks = widget.tasks
        ...
        .toList();
    Widget taskTile(BeanTask task) => _TaskItemTile(
      task: task,
...
class _ReminderListCardState extends State<_ReminderListCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final todayReminders = <BeanReminder>[];
    final upcomingReminders = <BeanReminder>[];
    final moreThanSevenDaysReminders = <BeanReminder>[];
    final moreThanThirtyDaysReminders = <BeanReminder>[];
    ...
    Widget reminderTile(BeanReminder reminder) => _ReminderItemTile(
      reminder: reminder,
